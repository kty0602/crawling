...
# 3. csv파일 생성
f = open(r"C:\Users\User\Desktop\vscode(python)\kcar_data(직영차_수입_스포츠카).csv", 'w', encoding ='utf-8-sig', newline='')
csvWriter = csv.writer(f)
link = ""
tag = "수입"
button = driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div[2]/div[2]/div[4]/div[1]/div[7]/div/ul/li[4]/button')
