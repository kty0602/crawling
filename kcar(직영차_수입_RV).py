...
# 3. csv파일 생성
f = open(r"C:\Users\User\Desktop\vscode(python)\kcar_data(직영차_수입_RV).csv", 'w', encoding ='utf-8-sig', newline='')
csvWriter = csv.writer(f)
link = ""
tag = "수입"
# button = driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div[2]/div[2]/div[4]/div[1]/div[7]/div/ul/li[12]/button')

for idx in range(1, 2):                    #몇 페이지까지 뽑아낼 것인가?
# 4. 데이터 추출
