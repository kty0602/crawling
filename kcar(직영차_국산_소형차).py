...
# 3. csv파일 생성
f = open(r"C:\Users\User\Desktop\vscode(python)\kcar_data(직영차_국산_소형차).csv", 'w', encoding ='utf-8-sig', newline='')
csvWriter = csv.writer(f)
link = ""
tag = "국산"
button = driver.find_element(By.XPATH, '//*[@id="app"]/div[2]/div[2]/div[2]/div[4]/div[1]/div[7]/div/ul/li[7]/button')

for idx in range(1, 7):                    #몇 페이지까지 뽑아낼 것인가?
# 4. 데이터 추출
