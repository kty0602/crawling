...
url = 'https://www.kbchachacha.com/public/search/main.kbc#!?countryOrder=2&page='
...
tag = '수입'
# # 2. 파일 생성
f = open(r"C:\Users\User\Desktop\vscode(python)\kb차차차(수입)_data.csv", 'w', encoding ='utf-8-sig', newline='')
